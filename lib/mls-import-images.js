  ...
  return new Promise(function(resolve, reject) {
    fileUploader.uploadSiteImage(mediaConfig.metasiteId,
      ...
      fileContent, uploadRequest, function (error, response) {
        ...
        let url = `wix:image://v1/${mediaFilename}.jpg/${fileName}#originWidth=${width}&originHeight=${height}`;
...
module.exports = async function importImages(client, item, mediaCredentials, mediaConfig, siteAPI, resourceID, keyField, logger, itemIndex) {
